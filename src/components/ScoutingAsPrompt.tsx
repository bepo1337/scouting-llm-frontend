...
export default function Chat() {
  ...
  return (
    <div className="w-full flex items-center justify-center ml-[20%]">
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="w-1/2 space-y-8 p-8 border-r-2">
          <FormField
      ...
      <div className="p-8 w-1/2 self-start max-w-1/2 sticky top-0"> <OriginalReports reports={originalReports}/></div>
